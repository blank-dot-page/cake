...
export class CakeV3Engine {
  private container: HTMLElement;
  private runtime: Runtime;
  private extensions: CakeExtensionV3[];
  ...
  constructor(options: EngineOptions) {
    ...
    this.runtime = createRuntimeV3(this.extensions);
  ...
  private handlePointerDown(event: PointerEvent) {
    ...
    if (event.pointerType === "touch") {
      ...
      // contentEditable updates the native DOM selection. Cake v3 currently
