...
describe("CakeV3Engine (browser)", () => {
  ...
  it("resolves extension keybinding conflicts by extension order (first match wins)", () => {
    ...
    const aExtension: CakeExtensionV3 = {
      name: "a",
      keybindings: [
        {
          key: "8",
    ...
    const bExtension: CakeExtensionV3 = {
      name: "b",
      keybindings: [
        {
          key: "8",
  ...
  it("does not prevent default when a keybinding command function returns null", () => {
    ...
    const nullBindingExtension: CakeExtensionV3 = {
      name: "null-binding",
      keybindings: [
        {
          key: "8",
  ...
  it("falls back to default paste when onPasteText returns null", () => {
    ...
    const nullPasteExtension: CakeExtensionV3 = {
      name: "null-paste",
      onPasteText: () => null,
    };
