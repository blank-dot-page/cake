...
describe("heading extension", () => {
  describe("parseBlock", () => {
    test("parses h1 heading", () => {
      const runtime = createRuntimeV3([headingExtension]);
    ...
    test("parses heading with bold content", () => {
      const runtime = createRuntimeV3([headingExtension, boldExtension]);
    ...
    test("parses heading with italic content", () => {
      const runtime = createRuntimeV3([headingExtension, italicExtension]);
