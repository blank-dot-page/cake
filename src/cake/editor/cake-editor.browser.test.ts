...
describe("CakeEditor Cmd+Backspace then backspace", () => {
  ...
  it("ctrl+Backspace followed by deleteContentBackward beforeinput still deletes the previous word", async () => {
    harness = createTestHarness("alpha beta\ngamma");
    ...
    (
      harness.engine as unknown as {
        pendingDeleteIntentFromKeydown: "delete-word-backward" | null;
      }
    ).pendingDeleteIntentFromKeydown = "delete-word-backward";
